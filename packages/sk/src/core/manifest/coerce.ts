 ...
 * Dependency Coercion
 *
 * Converts dependency declarations into validated, branded types.
 * Used by non-manifest entry points (e.g., marketplace parsing).
 */
...
import type { AbsolutePath, GitRef, NonEmptyString } from "@/src/core/types/branded"
import {
	coerceAbsolutePath,
	coerceGithubRef,
	coerceGitRef,
